    ...
    public class TrackerSequencerTests {
        ...
        public void TrivialSong_AppliesCellsInOrder_AndStopsAtEnd() {
            ...
            Assert.That(Controls(synth), Is.EqualTo(new[] {
                "SetChannelPan(0,0)", "SetChannelGain(0,1)", "SetChannelPatch(0)", "NoteOn(0,60,127)", "SetChannelPitchBend(0,0)",
                "NoteOff(0,60)", "NoteOn(0,64,127)", "SetChannelPitchBend(0,0)"
            }), "the initial pan seeds once at start (mono defaults to centre); each fresh note re-syncs the synth's pitch bend to 0.");
        ...
        public void InstrumentChange_ReselectsPatch_AndReleasesPrior() {
            ...
            Assert.That(Controls(synth), Is.EqualTo(new[] {
                "SetChannelPan(0,0)", "SetChannelPatch(0)", "NoteOn(0,60,127)", "SetChannelPitchBend(0,0)",
